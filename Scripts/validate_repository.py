...
if mode.exists():
    ...
    if "ATFGProductionAtmosphere" not in mode_text:
...
print("The Forbidden Gates Android repository validation passed through campaign level 100 and production content phase 1.")
